            ...
            <div className='max-w-7xl mx-auto mt-10 flex flex-col items-center'>
                <div className='flex flex-col items-center'>
                    <div className='flex items-center '>
                        <h1 className='text-5xl font-medium'>Episode name :</h1>
                        <h1 className='text-5xl ml-3 font-medium text-blue-600'>{episodeData?.name}</h1>
                    </div>
                    <span className='text-2xl font-medium mt-5'>Air date : {episodeData?.air_date}</span>
                </div>
                <div className='w-full flex justify-between mt-10'>
                    <div className='mr-5 min-w-80 flex flex-col items-center'>
                        <h2 className='mb-5 text-3xl font-bold'>Pick Episode</h2>
