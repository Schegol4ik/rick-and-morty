            ...
            <div className='max-w-7xl mx-auto mt-10 flex flex-col items-center p-1'>
                <div className='flex flex-col items-center'>
                    <div className='flex items-center '>
                        <h1 className='text-5xl font-medium max-sm:text-xl'>Location :</h1>
                        <h1 className='text-5xl ml-3 font-medium text-blue-600 max-sm:text-xl'>{locationData?.name}</h1>
                    </div>
                    <span className='text-2xl font-medium mt-5 max-sm:text-sm'>Dimension : {locationData?.dimension}</span>
                    <span className='text-xl font-medium max-sm:text-sm'>Type : {locationData?.type}</span>
                </div>
                <div className='w-full flex justify-between mt-10 max-sm:flex-wrap max-sm:justify-center'>
                    <div className='mr-5 min-w-80 flex flex-col items-center'>
                        <h2 className='mb-5 text-3xl font-bold max-sm:text-2xl'>Pick Location</h2>
